...
export const VolumeOffIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 20 20">
    <path fillRule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-14-14zM9.383 3.076A1 1 0 0110 4v.717L7.586 7.131A1 1 0 017 8v1.586l2 2V4l-3.447 2.824a1 1 0 01-.617.176H2a1 1 0 00-1 1v2a1 1 0 001 1h2.936L7 13.24V16a1 1 0 001.617.824L12.414 14l1.586 1.586A1 1 0 0015.414 14L10 8.586V4a1 1 0 00-.617-.924z" clipRule="evenodd" />
  </svg>
);
